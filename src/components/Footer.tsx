        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <a href={withBase("/")} className="mb-5 inline-flex">
              <img
                src={withBase("/logo-haus-garten-profi-white.svg")}
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/60">
              <li><a href={withBase("/#leistungen")} className="hover:text-primary-foreground transition-colors">Haussanierung</a></li>
              <li><a href={withBase("/#leistungen")} className="hover:text-primary-foreground transition-colors">Gartengestaltung</a></li>
              <li><a href={withBase("/#leistungen")} className="hover:text-primary-foreground transition-colors">Innenausbau</a></li>
              <li><a href={withBase("/#leistungen")} className="hover:text-primary-foreground transition-colors">Pflaster & Terrassen</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/60">
              ...
              <li><a href={withBase("/#projekte")} className="hover:text-primary-foreground transition-colors">Referenzen</a></li>
